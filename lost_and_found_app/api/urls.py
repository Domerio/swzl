...
urlpatterns = [
    ...
    path(
        "user/items/<int:pk>/", ItemUpdateAPI.as_view(), name="item-update"
    ),  # 修改物品详情
    path("found/categories/", views.get_found_categories, name="found_categories"),
    path(
        "category/name/<int:category_id>/",
        views.get_category_name,
        name="category-name",
    ),
    path(
        "lost/categories/tree/", LostCategoryListAPI.as_view(), name="category-tree"
    ),  # 添加失物分类树路径
    path(
        "found/categories/tree/", FoundCategoryListAPI.as_view(), name="category-tree"
    ),  # 添加招领分类树路径
    ...
    path(
        "admin/found-items/<int:item_id>/", views.admin_item_detail, name="admin_items"
    ),
    ...
    path(
        "report-found/<int:item_id>/",
        views.report_found_and_notify,
        name="report-found",
    ),
    path(
        "report-lost/<int:item_id>/", views.report_lost_and_notify, name="report-lost"
    ),
    ...
    path("stats/common_lost/", views.stats_common_lost, name="stats_common_lost"),
]
